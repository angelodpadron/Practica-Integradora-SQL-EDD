...
61	Básicamente un pozo	Fantastico	60	9	Facundo Alcodoy	Federico Barroso
...
22	Metegol	Animacion	106	8	David Masajnik	Juan Jose Campanella
...
26	Esperando la Carroza	Comedia	87	9	Antonio Gasalla	Alejandro Doria
...
DarthVader	Santiago Reyes	s12345w
...
DarthVader	Boardwalk Empire	2010
dcruz	Gunsmoke	1955
...
ALTER TABLE ONLY public.vio_pelicula
    ADD CONSTRAINT nombre_usuario_fk FOREIGN KEY (nombre_usuario) REFERENCES public.usuario(nombre_usuario);
...
ALTER TABLE ONLY public.vio_serie
    ADD CONSTRAINT vio_serie_fks FOREIGN KEY (nombre_serie, anho_serie) REFERENCES public.serie(nombre_serie, anho_serie);
